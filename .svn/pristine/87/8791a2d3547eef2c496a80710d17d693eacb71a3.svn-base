...
-(void)loadView
{
    ...
    [super loadView];
    self.loadingView=[[WaitView alloc] initWithFrame:CGRectMake(0, navBarHeight, screenWidth, screenHeight)];
...
-(void)showLoadingView
{
    ...
    [loadingView setLoadingViewStart];
