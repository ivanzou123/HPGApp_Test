...
//
//  Created by hwpl hwpl on 15-02-21.
...
@class PreDisImageViewController;
...
@property (nonatomic, assign) BOOL allowLoadMenu;
@property (nonatomic, retain) NSMutableArray *menuArr;

/**
 *  是否支持发送表情
 */
@property (nonatomic, assign) BOOL allowScrollToBottom; // default is YES
/**
 *  输入框的样式，默认为扁平化
 */
