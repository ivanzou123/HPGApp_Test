...
@property (nonatomic, copy) NSMutableAttributedString *originalAttributedTextWhenHighlighting;
...
@property (nonatomic, copy) NSMutableAttributedString *storedAttributedText;
#endif
...
+ (CGRect)frameRectWithAttributtedString:(NSMutableAttributedString *)attributedString
...
- (NSMutableAttributedString *)selectedAttributedText
{
    ...
    for (SETextAttachment *attachment in attachments) {
        ...
        if (!attachment.replacedString) {
            if (attachment.range.length > 0) {
                NSMutableAttributedString *originalAttributedString = (NSMutableAttributedString *)[editingAttributedText attributedSubstringFromRange:attachment.range];
                ...
                [editingAttributedText insertAttributedString:[[NSMutableAttributedString alloc] initWithString:replacementString] atIndex:attachment.range.location];
                attachment.replacedString = replacementString;
            }
    ...
    [attributedString enumerateAttribute:NSLinkAttributeName
                              ...
                              usingBlock:^(id value, NSRange range, BOOL *stop)
     {
         if (value) {
             ...
             //[self.attributedString addAttributes:attributeDict range:range];
             @try {
                 
                 [attributedString addAttribute:(id)kCTForegroundColorAttributeName value:(id)([UIColor blueColor].CGColor) range:range];
             }
...
#if TARGET_OS_IPHONE
    UIPasteboard *pasteboard = [UIPasteboard generalPasteboard];
    NSMutableAttributedString *storedAttributedText = self.storedAttributedText;
...
- (void)insertAttributedText:(NSMutableAttributedString *)attributedText
{
    NSRange selectedNSRange = self.textLayout.textSelection.selectedRange;
    SETextRange *markedTextRange = (SETextRange *)self.markedTextRange;
    NSRange markedTextNSRange;
...
- (void)replaceCharactersInRange:(NSRange)range withString:(NSString *)aString forAttributedString:(NSMutableAttributedString *)attributedString
{
    ...
    if (attribute) {
        [attributedString replaceCharactersInRange:range withAttributedString:[[NSMutableAttributedString alloc] initWithString:aString]];
    } else {
