...
@interface ApproveFunctionViewController ()
{
    UIWebView *htmlView;
    UILabel *noDataLable;
...
@implementation ApproveFunctionViewController
@synthesize tempArr;
@synthesize aprID;
@synthesize sysCode;
- (void)viewDidLoad {
    ...
    [userImageView1 setFrame:CGRectMake(lableWidth*2+gap, 23, imageWidth, imageHeight)];
    [v1 addSubview:userImageView1];
     numberBind = [[UILabel alloc] initWithFrame:CGRectMake(lableWidth*2+gap*2+5, 10, lableWidth-imageWidth-gap, 40)];
    //[numberBind setText:@"203905"];
    [numberBind setFont:[UIFont systemFontOfSize:12]];
    ...
    @try {
        ...
        dispatch_async(dispatch_get_main_queue(), ^(void){
            ...
            if ([@"A" isEqualToString:resMsg]) {
                ...
                [ApproveListViewController sharedInstance].refreshAprId = [NSString stringWithFormat:@"%i",(int)aprID];
