...
- (void)setupRefreshTime {
    if ([self.delegate respondsToSelector:@selector(lastUpdateTimeString)]) {
        ...
        if ([dateString isKindOfClass:[NSString class]] || dateString) {
            ...
            self.refreshActivityIndicatorContainerView.timeLabel.text = dateString;
        }
    }
}
...
- (void)setHasStatusLabelShowed:(BOOL)hasStatusLabelShowed {
    ...
    self.refreshActivityIndicatorContainerView.hasStatusLabelShowed = hasStatusLabelShowed;
}
    ...
    switch (refreshState) {
        ...
        case XHRefreshStateNormal: {
            switch (self.pullDownRefreshViewType) {
                case XHPullDownRefreshViewTypeCircle:
                    ...
                    break;
                case XHPullDownRefreshViewTypeActivityIndicator:
                     self.refreshActivityIndicatorContainerView.stateLabel.text = @"下拉刷新";
                    break;
                case XHPullDownRefreshViewTypeCustom:
                    break;
                default:
        ...
        case XHRefreshStateLoading: {
            if (self.pullDownRefreshing) {
                ...
                }else if (self.pullDownRefreshViewType == XHPullDownRefreshViewTypeActivityIndicator)
                {
                self.refreshActivityIndicatorContainerView.stateLabel.text = @"正在加载";
                }
        ...
        case XHRefreshStatePulling:
            switch (self.pullDownRefreshViewType) {
                case XHPullDownRefreshViewTypeCircle:
                    ...
                    break;
                case XHPullDownRefreshViewTypeActivityIndicator:
                     self.refreshActivityIndicatorContainerView.stateLabel.text = @"释放立即刷新";
                    break;
                case XHPullDownRefreshViewTypeCustom:
                    break;
                default:
        ...
        if (self.isPullDownRefreshed) {
            switch (self.pullDownRefreshViewType) {
                case XHPullDownRefreshViewTypeCircle:
                    ...
                    break;
                case XHPullDownRefreshViewTypeActivityIndicator:
                    [self.refreshActivityIndicatorContainerView.activityIndicatorView setTintColor:self.activeIndiactorColor];
                    NSLog(@"color:%p",self.activeIndiactorColor.CGColor);
