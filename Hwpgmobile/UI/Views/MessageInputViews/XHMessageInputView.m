...
@property (nonatomic, weak, readwrite) UIView *menuView;
...
//                if (self.allowLoadMenu) {
//                   //self.menuView.alpha=sender.selected;
//                }else
//                {
//                  
//                }
...
//        }
//            //self.menuView = nil;
//         UIView  *menuView = [[UIView alloc] initWithFrame:CGRectMake(50, 0, screenWidth-50, self.frame.size.height)];
//         float width = (screenWidth-50)/[menuArr count];
//            for (int i=0; i<[menuArr count]; i++) {
//                MenuButton *button;
//                NSDictionary *dic = [menuArr objectAtIndex:i];
//                NSString *title = [dic objectForKey:@"title"];
//               
//                button = [[MenuButton alloc] initWithFrame:CGRectMake(width*i, 0, width, self.frame.size.height)];
//                button.url = [dic objectForKey:@"url"];
...
{
    if ([self.delegate respondsToSelector:@selector(didClickMenuButton:)]) {
        [self.delegate didClickMenuButton:url];
    }
}
@end
