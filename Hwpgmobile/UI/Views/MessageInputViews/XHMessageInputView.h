...
@interface XHMessageInputView : UIImageView<menuButtonDeletegate>
 ...
 *  菜单控制
 */
@property (nonatomic, weak, readonly) NSMutableArray *menuMutableArr;


/**
 *  是否支持菜单
 */
@property (nonatomic, assign) BOOL allowLoadMenu; // default is No

/**
 *  是否支持菜单
 */
@property (nonatomic, weak,readonly) UIView *menuView; // default is No


@property (nonatomic, retain) NSMutableArray *menuArr; // default is No
