 ...
 *  @param indexPath 该目标消息在哪个IndexPath里面
 */
-(void)transPondMessage:(id<XHMessageModel>) message;
/**
 *  长按头像回调
 *
 *  @param message   被操作的目标消息Model
...
@interface XHMessageTableViewCell : XHBaseTableViewCell<SubsribeImageClick>
 ...
 *  重发标志
 */
@property (nonatomic, weak, readonly) UIButton *repeatSendButton;
/**
 *  重发标志
 */
@property (nonatomic, strong) UIActivityIndicatorView *sendLoadView;
/**
...
@property (nonatomic, assign) bool hasDisplayIndiactor;
