...
@interface CustomRootRefreshTableViewController : CustomRefreshTableViewController <XHRefreshControlDelegate>
 ...
 *  圆圈的颜色，默认是[UIColor colorWithRed:173 / 255.0 green:53 / 255.0 blue:60 / 255.0 alpha:1]
 */
@property (nonatomic, strong) UIColor *activeLoadIniactorColor;
/**
 *  圆圈的线条粗细,默认为1, 最大为2
 */
