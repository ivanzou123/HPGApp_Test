...
static ChatMessageViewController *instance = nil;
...
+(ChatMessageViewController *)shareInstance
{
    ...
    {
        if (instance == nil) {
            instance = [[ChatMessageViewController alloc] init];
        }
    }
    return instance;
}
...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    if (!doNotRefresh) {
        ...
        self.navigationItem.title = [self.groupTitle stringByAppendingFormat:@"(%i)",(int)totalCount];
        //
    ...
    [userDefault removeObjectForKey:@"fsSubScribeFont"];
}
...
-(void)chatSetting
{
    ...
    doNotRefresh = NO;
    MessageInfoSettingViewController *miSetting = [[MessageInfoSettingViewController alloc] init] ;
    miSetting.groupId = self.groupId;
    miSetting.chatGroupName = self.groupTitle;
    miSetting.groupId = self.groupId;
    UIBarButtonItem *temporaryBarButtonItem=[[UIBarButtonItem alloc] init];
    temporaryBarButtonItem.title=@"";
    self.navigationItem.backBarButtonItem = temporaryBarButtonItem;
