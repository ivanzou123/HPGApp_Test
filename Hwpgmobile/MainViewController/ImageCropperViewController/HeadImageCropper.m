...
@interface HeadImageCropper()<UINavigationControllerDelegate, UIImagePickerControllerDelegate, UIActionSheetDelegate, VPImageCropperDelegate,SocketIODelegate>{
    UIImageView *theImageView;
}

@end

static HeadImageCropper *instance = nil;

@implementation HeadImageCropper
//初始化单例
+(HeadImageCropper *)sharedImageCropper:(UIViewController *) fromViewController CanTap:(BOOL) canTap GroupId:(NSString *) groupId
{
    ...
    {
        if (instance==nil) {
            instance = [[HeadImageCropper alloc] init];
        }
